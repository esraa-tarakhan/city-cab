import 'package:citytaxi/pages/auth/bloc/auth_bloc.dart';
import 'package:citytaxi/pages/auth/widgets/otp_page.dart';
import 'package:citytaxi/pages/auth/widgets/phone_page.dart';
import 'package:citytaxi/pages/auth/widgets/set_up_account.dart';
import 'package:citytaxi/ui/theme.dart';
              ...
              : () {
                  if (_phoneController.text.isNotEmpty && state is AuthInitialState && _pageIndex == 0) {
                    BlocProvider.of<AuthBloc>(context)
                        .add(PhoneNumberVerificationEvent('+20${_phoneController.text}'));
                    ...
                    BlocProvider.of<AuthBloc>(context).add(PhoneAuthCodeVerifiedEvent(
                        _otpController.text, state.verificationId, '+20${_phoneController.text}'));
